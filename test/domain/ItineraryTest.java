...
public class ItineraryTest {
	...
	Itinerary itinerary1 = new Itinerary("FrogBomb", "Penny Blumenthal", flight1, "1C", BookingStatus.RESERVED);
	Itinerary itinerary2 = new Itinerary("Penny", "Penny Blumenthal", flight1, "3F", BookingStatus.RESERVED);
	Itinerary itinerary3 = new Itinerary("Penny", "John Doe", flight1, "3F", BookingStatus.RESERVED);
